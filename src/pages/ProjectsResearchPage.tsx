...
import { ExternalLink, Github, X, Eye, Star, GitFork, FileText, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="flex items-start justify-between gap-4 mb-4">
          <div className="flex items-center gap-3">
            ...
            <span className={`px-2 sm:px-3 py-1 text-xs font-medium rounded-full border ${statusColors[paper.status]}`}>
              {paper.status}
            </span>
          </div>
        </div>
        ...
        {/* Title */}
        <h3 className="font-display text-lg sm:text-xl md:text-2xl font-bold text-foreground mb-4">
          {paper.title}
        </h3>
        ...
        {/* Keywords */}
        <div className="mb-4">
          <h4 className="text-xs sm:text-sm font-semibold text-foreground mb-2 uppercase tracking-wider">
            Keywords
          </h4>
      ...
      <section className="min-h-screen pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20">
        <div className="container mx-auto px-4">
          ...
          <SectionTitle 
            ...
            subtitle="Innovative solutions and cutting-edge research"
          />
...
export default ProjectsResearchPage;